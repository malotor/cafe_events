...
class TabProjectionTest extends TestCase
{
     ...
     * @test
     */
    public function it_should_project_tab_opened_event()
    {
        $projection = new TabOpenedProjection($this->pdo);

        $event = new TabOpened(TabId::fromString("e247721a-b70c-4431-9ba5-1867340ae241"),1,'John');
