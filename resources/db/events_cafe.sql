CREATE TABLE items (item_id INTEGER NOT NULL, description VARCHAR(50) NOT NULL, price NUMERIC(10, 0) NOT NULL, is_drink BOOLEAN DEFAULT '1' NOT NULL, PRIMARY KEY(item_id));
CREATE TABLE tabs (tab_id VARCHAR(255) NOT NULL, waiter VARCHAR(50) NOT NULL, tableNumber VARCHAR(50) NOT NULL, open BOOLEAN DEFAULT '1' NOT NULL, amountPaid NUMERIC(10, 0) DEFAULT NULL, orderValue NUMERIC(10, 0) DEFAULT NULL, PRIMARY KEY(tab_id));
