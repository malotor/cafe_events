...
CREATE TABLE tabs (tab_id VARCHAR(255) NOT NULL, waiter VARCHAR(50) NOT NULL, tableNumber VARCHAR(50) NOT NULL, open BOOLEAN DEFAULT '1' NOT NULL, PRIMARY KEY(tab_id));
